...
var primaryColors = ['red', 'yellow', 'blue', 'green', 'orange', 'violet', 'indigo'];
...
/*
  2  temperature over 80 and humidity over 40 - return "I'm all sweat"
  3  temperature under 40 and cloudiness over 60 - return "I have icecicles"
  1  temperature over 80 and humidity under 40 and cloudiness under 20 - return "I'm literally in the desert"
  4  temperature over 80 or humidity over 50 or cloudiness over 50 - return "Hmm, probably not"
  5  Otherwise - return "I love outside"
*/
function outside(temp, hum, cloud) {
  if (temp > 80 && hum < 40 && cloud < 20 ) {
    return "I'm literally in the desert";
  }
  else if (temp > 80 && hum > 40) {
    return "I'm all sweat";
  }
  else if (temp < 40 && cloud > 50) {
